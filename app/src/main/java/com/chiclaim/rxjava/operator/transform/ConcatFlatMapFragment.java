...
public class ConcatFlatMapFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_switch_concat_flat_map_layout, container, false);
    }
    ...
    private synchronized Observable<String> createIpObservable(final String url, boolean isMain) {
        ...
        //@TODO thread safe so add synchronized key word to method why not works
        //if (!isMain) {
    ...
    private synchronized Observable<String> createIpObservable(final String url) {
        return Observable.create(new Observable.OnSubscribe<String>() {
            @Override
            public void call(Subscriber<? super String> subscriber) {
                try {
    ...
    private Observable<String> processUrlIpByConcatMapMultipleThread() {
        return createUrlObservable().concatMap(new Func1<String, Observable<String>>() {
            @Override
